...
class SLR_ME_ONE_PROXY:
    def __init__(self, y, w, act_params, iteration, burnin, thinning, add_chains=False):
        """
    ...
    def _sampling_s2_ep(self):
        ...
        # parameters of full conditionals
        shape = self.n/2
        scale = np.dot(np.dot(X, beta).reshape(self.n) - y ,
